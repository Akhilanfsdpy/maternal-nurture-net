...
import { Eye, Download, CheckCircle, Clock, PlusCircle, Shield, Scan } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/ui/tabs';
import EnhancedDocumentVerification from './EnhancedDocumentVerification';
import EnhancedDocumentScanner from './EnhancedDocumentScanner';
  ...
  return (
    <div className="space-y-8">
      ...
      <Tabs defaultValue="documents" value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="bg-white rounded-lg p-1 shadow-sm mb-6 w-full sm:w-auto">
          <TabsTrigger value="documents" className="rounded-md">Documents</TabsTrigger>
          <TabsTrigger value="verify" className="rounded-md flex items-center">
            <Shield className="h-4 w-4 mr-1.5" /> 
            Verify Documents
          </TabsTrigger>
          <TabsTrigger value="scan" className="rounded-md flex items-center">
